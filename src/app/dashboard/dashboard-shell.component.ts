...
@Component({
  ...
  template: `
    ...
    <section class="h-full p-8 flex items-center justify-center overflow-auto" [ngStyle]="backgroundStyle">
  ...
  get backgroundStyle() {
    return {
      background: `linear-gradient(
        ...
        #0C8DD6 ${3.95+this.temprature-13.93-40}%,
        #1AA0EC ${19.37+this.temprature-29.73-40}%,
        #60C6FF ${34.78+this.temprature-44.78-40}%,
        #9BDBFF ${50.19+this.temprature-93.21}%,
        #B4DEDA ${65.61+this.temprature-23.6+40}%,
        #FFD66B ${81.02+this.temprature+46.02+40}%,
        #FFC178 ${96.44+this.temprature-106.44+40}%,
